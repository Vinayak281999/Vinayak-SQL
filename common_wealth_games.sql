...
SELECT lpad('maruti', 10, 'AA');
SELECT lpad('maruti', 8, 'AA');
SELECT lpad('maruti', 3, 'AA');
SELECT lpad('maruti', 5, 'AA');
SELECT lpad('maruti', 14, 'AA');

/* rpad */
SELECT rpad('maruti', 10, 'AA');
SELECT rpad('maruti', 15, 'AA');
SELECT rpad('maruti', 9, 'AA');
SELECT rpad('maruti', 2, 'AA');
SELECT rpad('maruti', 6, 'AA');
